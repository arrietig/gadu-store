...
const WINES = [
    ...
    /* ── Mosquita Muerta ── */
    { id: 27, name:"Pispi",                                brand:"mosquita",    type:"Tinto",     price:300000,  color:"#722F37", photo:"IMAGENES/catalogo/mosquita/pispi.png" },
    { id: 28, name:"Perro Callejero",                      brand:"mosquita",    type:"Tinto",     price:230000,  color:"#8B3A3A", photo:"IMAGENES/catalogo/mosquita/perro-callejero.png" },
    { id: 29, name:"Sapo de Otro Pozo",                    brand:"mosquita",    type:"Tinto",     price:400000,  color:"#5A1020", photo:"IMAGENES/catalogo/mosquita/sapo-de-otro-pozo.png" },
    { id: 24, name:"Malcriado",                            brand:"mosquita",    type:"Tinto",     price:580000,  color:"#5A1020", photo:"IMAGENES/catalogo/mosquita/malcriado.png" },
    { id:  1, name:"Cordero con Piel de Lobo",             brand:"mosquita",    type:"Tinto",     price:170000,  color:"#722F37", photo:"IMAGENES/catalogo/mosquita/cordero-malbec.png" },
    { id:  2, name:"Cordero con Piel de Lobo Chardonnay",  brand:"mosquita",    type:"Blanco",    price:180000,  color:"#8B7020" },
    { id: 20, name:"Mosquita Muerta",                      brand:"mosquita",    type:"Tinto",     price:260000,  color:"#722F37", photo:"IMAGENES/catalogo/mosquita/mosquita-muerta.png" },
